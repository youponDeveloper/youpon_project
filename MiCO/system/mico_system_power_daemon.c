...
extern void wifi_config_press_irq_cb();

USED void PlatformEasyLinkButtonClickedCallback(void)
{
  system_log_trace();
 
  wifi_config_press_irq_cb();
...
USED void PlatformEasyLinkButtonLongPressedCallback(void)
{
 ...
 //   printf("PlatformEasyLinkButtonLongPressedCallback in ....");
...
printf("_sys_power_state_change_handler in ....reboot!");
