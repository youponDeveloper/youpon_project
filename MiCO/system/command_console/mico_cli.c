...
static const struct cli_command built_ins[] = {
  ...
  {"sensorlist", "show sensorlist info",  print_sensor_device_info},
  {"timerlist", "show timer_ctrl_list info", print_timer_ctrl_info},
  {"devicelist","show device list info", print_device_infomation},
  {"linkagelist", "show linkage list info", print_linkage_list},
  {"rmdevice","clear all device recode inflash",clear_all_device_recode_inflash},
};
