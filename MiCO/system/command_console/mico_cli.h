...
extern void print_sensor_device_info();
extern void print_timer_ctrl_info();
extern void print_device_infomation();
extern void  print_linkage_list();
extern void clear_all_device_recode_inflash();
#ifdef MOC
